...
public class CustomOreGen
{
    ...
    public static void registerOres(){
        ...
        overworldOres.add(register("bixbit_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                ...
                .range(40).square()
                .func_242731_b( 8)));
        overworldOres.add(register("malachite_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.MALACHITE_ORE.get().getDefaultState(), 4))
                .range(40).square()
                .func_242731_b( 8)));
        overworldOres.add(register("onyx_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.ONYX_ORE.get().getDefaultState(), 4))
                .range(40).square()
                .func_242731_b( 8)));
        overworldOres.add(register("peridot_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
        ...
        overworldOres.add(register("sun_stone_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                ...
                .range(40).square()
                .func_242731_b( 8)));
        overworldOres.add(register("citrine_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.CITRINE_ORE.get().getDefaultState(), 4))
                .range(40).square()
                .func_242731_b( 8)));
        overworldOres.add(register("dolomite_ore", Feature.ORE.withConfiguration(new OreFeatureConfig(
                OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.DOLOMITE_ORE.get().getDefaultState(), 4))
                .range(40).square()
                .func_242731_b( 8)));
