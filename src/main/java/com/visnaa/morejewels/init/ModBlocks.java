...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MOON_STONE_BLOCK = BLOCKS.register("moon_stone_block", () -> new Block(AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance(5.0F, 30.0F).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.METAL)));
